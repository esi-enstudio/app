...
const classes = computed(() =>
    props.active
        ? 'block w-full px-4 py-2 text-start text-sm leading-5 text-gray-700 transition duration-150 ease-in-out bg-gray-200 focus:bg-gray-300 focus:outline-none dark:text-gray-300 dark:hover:bg-gray-800 dark:focus:bg-gray-800'
